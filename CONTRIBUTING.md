...
Thanks for looking! PRs that sharpen reliability, security, or test coverage are welcome.

## Contact

Security reports and questions: ankitmaurya2531@gmail.com (see [SECURITY.md](SECURITY.md)).

## Dev setup

```bash
git clone https://github.com/ankitmaurya-16/document_AI.git
cd document_AI
